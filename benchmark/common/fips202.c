...
/*
static void shake128_absorb(uint64_t *s, const unsigned char *input, unsigned
int inputByteLen)
{
...
//                              const unsigned char *in, unsigned long long
//                              inlen)
// {
...
// void cshake128_simple_squeezeblocks(unsigned char *output, unsigned long long
// nblocks, uint64_t *s)
// {
//   keccak_squeezeblocks(output, nblocks, s, SHAKE128_RATE);
// }
